"""
Django settings for sachstore project.
...
SECRET_KEY = 'django-insecure-e3rm-l=m^m*lty0r^m+&ba(4n0r43rzf3d+qyhg5_#n8^wi8p-'
...
WSGI_APPLICATION = 'sachstore.wsgi.application'
